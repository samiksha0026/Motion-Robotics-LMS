      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-semibold text-gray-900">Our Lab</h1>
          </div>
        </div>
      </header>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                  {labInfo.photos.map((photo, idx) => (
                    <button key={photo.id} onClick={() => openLightbox(idx)}
                      className="relative aspect-square rounded-xl overflow-hidden bg-gray-100 hover:ring-2 hover:ring-indigo-400 transition-all group">
